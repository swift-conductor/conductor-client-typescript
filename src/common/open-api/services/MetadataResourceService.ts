...
export class MetadataResourceService {
    ...
    public validate(
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/api/metadata/workflow/validate',
            body: requestBody,
            mediaType: 'application/json',
        });
    }
     ...
     * @throws ApiError
     */
    public getWorkflowNamesAndVersions(): CancelablePromise<Record<string, Record<string, any>>> {
        return this.httpRequest.request({
            method: 'GET',
            url: '/api/metadata/workflow/names-and-versions',
        });
    }
    /**
     ...
     * @throws ApiError
     */
    public getAllWorkflowsWithLatestVersions(): CancelablePromise<Array<WorkflowDef>> {
        return this.httpRequest.request({
            method: 'GET',
            url: '/api/metadata/workflow/latest-versions',
        });
    }
    /**
